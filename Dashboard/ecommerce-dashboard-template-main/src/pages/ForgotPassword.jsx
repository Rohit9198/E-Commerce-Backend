      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-purple-200 px-4">
        <div className="bg-white shadow-lg rounded-2xl max-w-md w-full p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="px-2 flex justify-end items-center text-sm text-grya-500">
              <Link
                to={"/login"}
                type="button"
            ...
            <div className="px-2">
              <button
                type="submit"
                className="w-full flex justify-center items-center gap-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white 
