...
import { generateEmailTemplate } from "../utils/generateForgotPasswordEmailTemplates.js";
...
export const updatePassword = catchAsyncError(async( req, res, next) => {
    ...
    if(!isPasswordMatch){
        return next(new ErrorHandler("current password is icorrect.", 400));
